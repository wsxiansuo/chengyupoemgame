...
public class DBHelper{
     ...
     private String rootDirectory = "/data/data/com.sxs.chengyupoemgame.main/data/";
     private final String DATABASE_PATH = android.os.Environment.getExternalStorageDirectory().getAbsolutePath()
     + "/everydaypoem";
     private final String DATABASE_FILENAME = "chengyupoemgame.db";
     ...
     public SQLiteDatabase updateDatabase(){
         ...
         {   
             ...
             {   
                 ...
                 InputStream is = context.getResources().openRawResource(R.raw.chengyupoemgame);   
